  ...
  return (
    <>
      ...
      <Stack spacing={2} marginTop={2} sx={{backgroundColor: "#23272a"}} >
        <Link href="https://github.com/" style={{ textDecoration: 'none' }} target="_blank">
        ...
        <Link href="https://www.lighthouselabs.ca/en" style={{ textDecoration: 'none' }} target="_blank">
          <div className="server">
        ...
        <Link href="https://web.compass.lighthouselabs.ca" style={{ textDecoration: 'none' }} target="_blank">
          <div className="server">
        ...
        <Link href="https://skribbl.io/" style={{ textDecoration: 'none' }} target="_blank">
          <div className="server">
        ...
        <Link href="https://code.visualstudio.com/" style={{ textDecoration: 'none' }} target="_blank">
          <div className="server">
        ...
        <Link href="https://developer.mozilla.org/en-US/" style={{ textDecoration: 'none' }} target="_blank">
          <div className="server">
            <Avatar alt="MDN" src="/assets/servers/s_6.png" sx={{ width: 56, height: 56, backgroundColor: "#23272a" }}/>
            <h4 className="serverName">MDN</h4>
          </div>
        </Link>
        <Link href="https://stackoverflow.com/" style={{ textDecoration: 'none' }} target="_blank">
          <div className="server">
